...
comments: true
date: 2009-10-16 19:04:20+00:00
layout: post
...
Potem  trzygodzinna podróż do Grodu Kraka i 15 minutowy spacer z dworca na  Uniwersytet Ekonomiczny, gdzie miała odbyć się konferencja.<!-- more -->
...
**Jak usprawnić model domeny wykorzystując jBPM? by [Tom Baeyens](http://09.jdd.org.pl/prelegenci/tom-baeyens) i [Joram Barrez](http://09.jdd.org.pl/joram-barrez)**
...
**Sztuka messagingu by [Mark Richards](http://09.jdd.org.pl/prelegenci/mark-richards)**
...
Prezentacja z tego wykładu do pobrania [tutaj](http://www.wmrichards.com/slides/).

Ostatnim wykładem przed przerwą obiadową był

**Obsługa sytuacji wyjątkowych w systemach budowanych w technologii JEE by [Tomasz Skutnik, e-point](http://09.jdd.org.pl/prelegenci/tomasz-skutnik)**
...
Potem każdy miał sporo czasu, żeby odwiedzić stoiska na  holu. Można było sprawdzić jak wyglądają certyfikaty Suna, a nawet  pograć w parach na konsoli. Przede wszystkim jednak można było spotkać  mniej lub bardziej znanych ludzi z polskiego javowego środowiska. Ja na  przykład poznałem [Tomka Nurkiewicza](http://nurkiewicz.blogspot.com/), z którym, jak się okazało, mamy wspólnych znajomych :)

**Asynchroniczność,  współbieżność i rozproszone przetwarzanie w Java EE – przykłady z  użyciem technologii middleware Oracle: WebLogic Server,  EclipseLink/TopLink JPA i Coherence by [Waldemar Kot, Oracle](http://09.jdd.org.pl/prelegenci/waldemar-kot)**
...
**Java dla dużych chłopców, czyli Lego Mindstorms i leJOS by [Jacek Kunicki](http://09.jdd.org.pl/prelegenci/jacek-kunicki)**
...
**Anty-wzorce programowania, czyli czego NIE robić by [Mark Richards](http://09.jdd.org.pl/prelegenci/mark-richards)**

Drugi  wykład prowadzony przez tego prelegenta i, jak już wspomniałem, moim  zdaniem najlepszy na całej konferencji. Prowadzący ciekawie i z humorem  omówił kilka najczęstszych złych praktyk tworzenia oprogramowania.  Porównanie programistów bezrefleksyjnie wybierających używane  technologie do czcicieli [kultu cargo](http://pl.wikipedia.org/wiki/Kult_cargo) było bardzo ciekawe i chyba wielu zapadło w pamięć. Stąd termin [cargo cult programming](http://en.wikipedia.org/wiki/Cargo_cult_programming).
Prezentację z wykładu można pobrać [stąd](http://www.wmrichards.com/slides/).

**O czym wiedzą najlepsi programiści? by [Michał Bartyzel](http://09.jdd.org.pl/prelegenci/michal-bartyzel) i [Mariusz Sieraczkiewicz](http://09.jdd.org.pl/prelegenci/mariusz-sieraczkiewicz)**
...
**Architektura Resource-Oriented (ROA) i REST by [Scott Davis](http://09.jdd.org.pl/prelegenci/scott-davis)**
...
A już za tydzień kolejna impreza javowa, tym razem w Warszawie: [Warsjawa, czyli zwinnie o Javie](http://warsjawa.pl/).
