...
comments: true
date: 2010-01-23 13:10:13+00:00
layout: post
slug: finally-my-scwcd-mission-completed
title: Finally my SCWCD mission completed
wordpress_id: 41
categories:
- Certificates
- Java
...
The final impulse to take the exam was promotion from Sun connected with Kirk Pepperdine's talk at Warsaw JUG (more about this promotion in Polish can be found at [Jacek Laskowski blog](http://jlaskowski.blogspot.com/2010/01/pakiety-certyfikacyjne-od-suna-za-600.html)). I saved about 300 Polish Zlotys, bought exam voucher and e-simulator with example questions which at the end turned out to be very similar to real exam (not surprising at all :) ). This simulator, free mocks and notes available at [JavaRanch Forum](http://faq.javaranch.com/java/ScwcdLinks) and questions from Head First book was more than enough and this time I didn't buy simulator from WhizLabs or Enthuware.
