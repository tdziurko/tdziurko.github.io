---
layout: post
title: Programista i własna firma, czyli dotacja z Urzędu Pracy na założenie działalności gospodarczej
description: Moja droga do uzyskania dotacji na założenie JDG jako Programista 
date: 2010-07-15
author: tomek
...
Jakiś czas temu zakończyłem trwający ponad trzy miesiące proces zdobywania dotacji z Urzędu Pracy na założenie własnej 
działalności gospodarczej. Poniżej dla osób zainteresowanych opisuję jak to wygląda od strony praktycznej, bo przy 
włożeniu pewnej dozy wysiłku, czasu i chęci można zdobyć spory zastrzyk gotówki (do 19 tysięcy złotych) i mieć łatwiejszy 
start przy rozkręcaniu własnej firmy.


{: .tip }
Dear Reader, this post is in my native language as it covers topic that is relevant only for people from Poland. But please feel free to browse my other articles as majority of them are written in English.
...
Warunek, który trzeba spełnić, aby w ogóle móc ubiegać się o dotację jest jeden: trzeba być zarejestrowanym w swoim Urzędzie Pracy jako osoba bezrobotna, a co warto podkreślić, studenci zaoczni mogą mieć status bezrobotnego, więc mogą również ubiegać się o tę dotację. 

{: .important }
**Ważne** Niektóre UP wymagają, aby status bezrobotnego posiadać przez określony czas: 1, 3 a nawet 6 miesięcy. O szczegóły trzeba dopytać w swoim UP, bo pod tym względem w różnych regionach Polski są spore różnice. Przy okazji warto zapytać również, czy mają jeszcze środki na dotacje, bo u mnie w Płocku podobno skończyły się one już w połowie czerwca i nie wiadomo czy będą jeszcze w tym roku kalendarzowym.
...
Gdyby ktoś miał pytania zapraszam również do kontaktu przez podstronę */contact*